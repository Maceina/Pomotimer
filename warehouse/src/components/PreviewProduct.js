        ...
        <Fragment>
            <div className="w-full max-w-sm container mt-20 mx-auto">
                ...
                <div className="flex-grow text-center px-4 py-2 m-2">
                    ...
                    <div className="flex-grow text-center px-4 py-2 m-2">
                    <div className="bg-green-400 hover:bg-green-500 text-white font-semibold py-2 px-4 rounded inline-flex items-center"><Link to='/'>Go to the main page</Link></div>
                    </div>
            </div>
        </Fragment>
    )
